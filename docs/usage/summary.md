...
Generated 2026-09-15T09:51:02Z by `docs/usage/usage_from_transcripts.py` from `/Users/dk/.claude/projects/-Users-dk-Projects-3d-render-blender-3rd-attempt-building` (9 main sessions, 118 subagent transcripts). Usage is deduplicated by API message id. Tokens in thousands (k) unless stated.
...
|---|---|---|---|---|---|---|---|---|
| claude-opus-5 | 7982 | 16 | 5,119 | 2,546 | 0 | 52,418 | 1,339,710 | 1,125.52 |
| claude-fable-5-1 | 1522 | 41 | 1,663 | 601 | 6,898 | 11,613 | 332,937 | 449.92 |
| claude-sonnet-5 | 25 | 0 | 25 | 15 | 0 | 107 | 1,903 | 0.90 |
| <synthetic> | 27 | 0 | 0 | 0 | 0 | 0 | 0 | 0.00 |

**Grand total nominal cost: $1,576.34**
...
| 8 | 6460c313 | 2026-09-15T07:49 | 2026-09-15T09:50 | 2.03 | 90 | 4 | 77.94 | opus-5 65, fable-5-1 13 |
...
| 2026-09-15 | 85.20 | 20.56 | 64.64 | 0.00 |
...
- Session 8 (6460c313): 4 x opus-5 ($65). Types: {'general-purpose': 4}
...
| 8 | - | - | - | - | - | - | - | 2 ($5) | - | 2 ($59) | 4 ($65) |
| 9 | - | - | - | - | - | - | - | - | - | - | 0 ($0) |
| all | 4 ($24) | 12 ($126) | 9 ($126) | 11 ($217) | 12 ($299) | 15 ($314) | 11 ($93) | 40 ($71) | 2 ($6) | 2 ($59) | 118 ($1337) |

Lead (main thread) cost per session, same rates: session 1 $33, session 2 $16, session 3 $48, session 4 $37, session 5 $60, session 6 $30, session 7 $1, session 8 $13, session 9 $1.
