...
Generated 2026-09-19T13:09:46Z by `docs/usage/usage_from_transcripts.py` from `/Users/dk/.claude/projects/-Users-dk-Projects-3d-render-blender-3rd-attempt-building` (14 main sessions, 201 subagent transcripts). Usage is deduplicated by API message id. Tokens in thousands (k) unless stated.
...
| claude-fable-5-1 | 2500 | 60 | 2,423 | 795 | 11,326 | 11,613 | 604,446 | 644.57 |
| claude-sonnet-5 | 100 | 0 | 54 | 28 | 0 | 492 | 7,376 | 3.24 |
| <synthetic> | 28 | 0 | 0 | 0 | 0 | 0 | 0 | 0.00 |

**Grand total nominal cost: $3,237.18**
...
| 14 | 3ada03f9 | 2026-09-17T21:16 | 2026-09-19T13:08 | 39.87 | 318 | 21 | 449.05 | opus-5 377, fable-5-1 71 |
...
| 2026-09-19 | 241.14 | 38.79 | 202.34 | 0.00 |
...
Lead (main thread) cost per session, same rates: session 1 $33, session 2 $16, session 3 $48, session 4 $37, session 5 $60, session 6 $30, session 7 $1, session 8 $69, session 9 $1, session 10 $5, session 11 $19, session 12 $25, session 13 $18, session 14 $71.
