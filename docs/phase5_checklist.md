...
4. 4K hero timing FIRST at 128 spp fixed, adaptive OFF, time_limit 0, 3840x2160, cam01, final preset, through blender_run.sh with max 7200 s
   ...
   (target: the final frame under 90 min; 768 spp only if 128 spp took < 12 min). User rule (2026-09-09): if native 4K is too slow for the 90 min budget, render at 2560 wide and upscale to 3840x2160 (sips); state which path was taken.
