# QA round 18 — Gate 5, the web deployment (brief from the lead, 2026-09-18; staging URL and capture tag filled at dispatch). Opus 5 xhigh. Fresh agent.
...
Inputs (capture tag `gate5`, taken 2026-09-18 16:40-17:10 UTC against the URL; the deploy log renders/logs/6b_deploy_1.log): the staging URL `https://pfa-walkthrough.3d-render-blender-3rd-attempt-building.workers.dev`; the "gate5" capture taken against it by web/tools/gate5.sh (stations 1-6 at
