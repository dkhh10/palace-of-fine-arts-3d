...
Burn so far today (list rates): session 6460c313 $586.08 (overnight bake, spanned the 15th/16th), session 2 $46.70, session 3 (87d95e57) see the table line printed at this checkpoint / re-run the script at the next start.
