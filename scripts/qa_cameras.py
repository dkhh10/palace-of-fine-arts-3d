...
CAMERAS = [
    ...
    dict(name="CAM_qa_03_colonnade_walk", loc=(40.0, -21.0, 1.7), target=(0.0, 0.0, 18.0), lens=20.0,
    ...
    dict(name="CAM_qa_05_south_lawn", loc=(45.0, 55.0, 1.4), target=(0.0, 0.0, 20.0), lens=20.0,
