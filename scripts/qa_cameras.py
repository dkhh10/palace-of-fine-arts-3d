...
CAMERAS = [
    dict(name="CAM_qa_01_lagoon_hero", loc=(-14.1, 100.0, 1.0), target=(0.0, 0.0, 1.0), lens=27.0, shift_y=0.17,
    ...
    dict(name="CAM_qa_02_lagoon_ne_threequarter", loc=(-30.0, 35.0, 1.3), target=(0.0, 0.0, 20.0), lens=26.0,
