...
CAMERAS = [
    dict(name="CAM_qa_01_lagoon_hero", loc=(-14.1, 100.0, 1.6), target=(0.0, 0.0, 1.6), lens=24.0, shift_y=0.09,
    ...
    dict(name="CAM_qa_02_lagoon_ne_threequarter", loc=(-33.0, 38.0, 1.3), target=(0.0, 0.0, 24.0), lens=20.0,
    ...
    dict(name="CAM_qa_03_colonnade_walk", loc=(61.0, -8.0, 1.7), target=(0.0, 0.0, 16.0), lens=18.0,
    ...
    dict(name="CAM_qa_05_south_lawn", loc=(38.0, 45.0, 1.4), target=(0.0, 0.0, 22.0), lens=20.0,
