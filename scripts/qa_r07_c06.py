"""QA round 07: the cam06 gate needs a PAIR of frames (composited / un-composited), so QA renders the
un-composited twin of round07_06_aerial.png from the same master. Read-only: nothing is saved back.

    blender -b --python scripts/qa_r07_c06.py -- [--blend master.blend]

Writes renders/previews/qa/round07_06_aerial_nocomp.png (Eevee 1280x720, 32 TAA, LOD1 -- the same rig as the
...
out = common.RENDERS / "previews" / "qa" / "round07_06_aerial_nocomp.png"
