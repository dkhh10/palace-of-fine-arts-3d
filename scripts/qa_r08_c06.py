"""QA round 08: the cam06 gate needs a PAIR of frames (composited / un-composited), so QA renders the
...
Writes renders/previews/qa/round08_06_aerial_nocomp.png (Eevee 1280x720, 32 TAA, LOD1 -- the same rig as the
...
out = common.RENDERS / "previews" / "qa" / "round08_06_aerial_nocomp.png"
