...
# =============================================================================== materials
def concrete_material(name, tex_set, seed, params, specular=0.18, column=None, baked=False, extra=None):
...
def build_concrete_family():
    ...
    concrete_material("MAT_concrete_colonnade", "concrete_wall_007", 3.0, {
        ...
        "Algae": 1.0, "Algae Z": WATER_Z, "Algae Height": 1.0,
        "Patches": 0.15, "Edge Wear": 0.65, "Edge Radius": 0.18, "Recess Dirt": 0.6, "Recess Distance": 0.7, "Cavity": 0.40,
    ...
    concrete_material("MAT_column_rose", "concrete_wall_008", 6.0, {
        ...
        "Algae": 0.0,
        "Patches": 0.0, "Edge Wear": 0.5, "Edge Radius": 0.07,
        "Recess Dirt": 0.65, "Recess Distance": 0.40, "Cavity": 0.45, "Roughness": 0.72, "Roughness Variation": 0.1, "Bump": 0.3, "Pour Lines": 0.0},
        specular=0.18,
    ...
    concrete_material("MAT_column_tan_inner", "concrete_wall_008", 7.0, {
        ...
        "Algae": 0.0,
        "Patches": 0.0, "Edge Wear": 0.55, "Edge Radius": 0.07,
        "Recess Dirt": 0.6, "Recess Distance": 0.40, "Cavity": 0.45, "Roughness": 0.78, "Roughness Variation": 0.1, "Bump": 0.3, "Pour Lines": 0.0},
...
def build_water():
    ...
    Pa = t.combxyz(t.mul(wx, 0.50), wy, 0.0)
