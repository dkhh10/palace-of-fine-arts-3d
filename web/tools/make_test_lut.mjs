...
//   node tools/make_test_lut.mjs            -> testdata/gamma22.cube  (domain 0..1)
//   node tools/make_test_lut.mjs 4          -> testdata/gamma22_d4.cube (domain 0..4)
...
fs.writeFileSync( `testdata/${name}`, out.join( '\n' ) + '\n' );
console.log( `wrote testdata/${name} (${N}^3)` );
